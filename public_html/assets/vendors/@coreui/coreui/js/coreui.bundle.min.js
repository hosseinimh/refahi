...
!(function (t, e) {
  ...
  class _t extends B {
    ...
    _addTouchEventListeners() {
      const e = (t) => {
        ...
        n = (t) => {
          !this._pointerEvent || ("pen" !== t.pointerType && t.pointerType !== mt) || (this.touchDeltaX = t.clientX - this.touchStartX),
            this._handleSwipe(),
  ...
  j.on(document, ft, "[data-coreui-slide], [data-coreui-slide-to]", _t.dataApiClickHandler),
    j.on(window, ut, () => {
  ...
  function we(t) {
    ...
    return i && ("html" === oe(i) || ("body" === oe(i) && "static" === me(i).position))
      ? e
      : i ||
          (function (t) {
  ...
  function Se(t) {
    ...
    if (c) {
      var w = we(i),
        E = "clientHeight",
        A = "clientWidth";
      w === re(i) && "static" !== me((w = ve(i))).position && "absolute" === a && ((E = "scrollHeight"), (A = "scrollWidth")),
        (w = w),
        (s !== Mt && ((s !== Ht && s !== Pt) || o !== qt)) || ((b = jt), (g -= w[E] - n.height), (g *= l ? 1 : -1)),
        (s !== Ht && ((s !== Mt && s !== jt) || o !== qt)) || ((v = Pt), (f -= w[A] - n.width), (f *= l ? 1 : -1));
    }
    var T,
      L = Object.assign({ position: a }, c && Ne);
    return l
      ? Object.assign({}, L, (((T = {})[b] = _ ? "0" : ""), (T[v] = m ? "0" : ""), (T.transform = (y.devicePixelRatio || 1) <= 1 ? "translate(" + f + "px, " + g + "px)" : "translate3d(" + f + "px, " + g + "px, 0)"), T))
      : Object.assign({}, L, (((e = {})[b] = _ ? g + "px" : ""), (e[v] = m ? f + "px" : ""), (e.transform = ""), e));
  }
  var Ie = {
      name: "computeStyles",
      enabled: !0,
      ...
      ? Ve(
          (function (t) {
            var e = re(t),
              ...
              r = 0,
              a = 0;
            return n && ((s = n.width), (o = n.height), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) || ((r = n.offsetLeft), (a = n.offsetTop))), { width: s, height: o, x: r + We(t), y: a };
          })(t)
        )
      : le(e)
      ? (function (t) {
      ...
      : Ve(
          (function (t) {
            var e,
              ...
              a = -n.scrollLeft + We(t),
              l = -n.scrollTop;
            return "rtl" === me(s || i).direction && (a += Ae(i.clientWidth, s ? s.clientWidth : 0) - o), { width: o, height: r, x: a, y: l };
          })(ve(t))
        );
  }
  function Ke(t, e, i) {
        ...
        (("body" !== oe(e) || qe(a)) &&
          (c =
            (n = e) !== re(n) && le(n)
              ...
              : Re(n)),
        le(e) ? (((h = fe(e, !0)).x += e.clientLeft), (h.y += e.clientTop)) : a && (h.x = We(a))),
      {
  ...
  class Bi extends B {
    ...
    show() {
      ...
      if (!j.trigger(this._element, Ei, e).defaultPrevented) {
        ...
        "ontouchstart" in document.documentElement && !t.closest(".navbar-nav") && [].concat(...document.body.children).forEach((t) => j.on(t, "mouseover", u)),
          this._element.focus(),
    ...
    _completeHide(t) {
      j.trigger(this._element, yi, t).defaultPrevented ||
        ("ontouchstart" in document.documentElement && [].concat(...document.body.children).forEach((t) => j.off(t, "mouseover", u)),
  ...
  class dn extends B {
    ...
    show(t) {
      ...
      j.trigger(this._element, en, { relatedTarget: t }).defaultPrevented ||
        ...
        j.on(this._element, on, '[data-coreui-dismiss="modal"]', (t) => this.hide(t)),
  ...
  class Wn extends B {
    ...
    show(t) {
      ...
      (this._isShown = !0),
        ...
        this._backdrop.show(),
        this._config.scroll || (new qi().hide(), this._enforceFocusOnElement(this._element)),
        this._element.removeAttribute("aria-hidden"),
        this._element.setAttribute("aria-modal", !0),
        this._element.setAttribute("role", "dialog"),
    ...
    _addEventListeners() {
      j.on(this._element, Bn, '[data-coreui-dismiss="offcanvas"]', () => this.hide()),
        j.on(this._element, Rn, (t) => {
  ...
  j.on(document, Hn, '[data-coreui-toggle="offcanvas"]', function (e) {
    ...
    j.on(window, kn, () => t.find(Sn).forEach((t) => Wn.getOrCreateInstance(t).show())),
    _(Wn);
  ...
  class ls extends B {
    ...
    show() {
      ...
      H.set(n, this.constructor.DATA_KEY, this),
        this._element.ownerDocument.documentElement.contains(this.tip) || (a.appendChild(n), j.trigger(this._element, this.constructor.Event.INSERTED)),
        this._popper ? this._popper.update() : (this._popper = di(this._element, n, this._getPopperConfig(r))),
        n.classList.add(ns);
    ...
    setElementContent(t, e) {
      if (null !== t)
        return r(e)
          ...
          : void (this._config.html ? (this._config.sanitize && (e = Kn(e, this._config.allowList, this._config.sanitizeFn)), (t.innerHTML = e)) : (t.textContent = e));
    }
    getTitle() {
    ...
    _setListeners() {
      this._config.trigger.split(" ").forEach((t) => {
        ...
        j.on(this._element.closest(".modal"), "hide.coreui.modal", this._hideModalHandler),
    ...
    _leave(t, e) {
      (e = this._initializeOnDelegatedTarget(t, e)),
        t && (e._activeTrigger["focusout" === t.type ? as : rs] = e._element.contains(t.relatedTarget)),
    ...
    _activate(e) {
      ...
      n.classList.add(Ls),
        n.classList.contains(Ts)
          ? t.findOne(".dropdown-toggle", n.closest(".dropdown")).classList.add(Ls)
          : t.parents(n, ".nav, .list-group").forEach((e) => {
              t.prev(e, ".nav-link, .list-group-item").forEach((t) => t.classList.add(Ls)),
  ...
  class go extends B {
    ...
    _setListeners() {
      j.on(this._element, to, '[data-coreui-dismiss="toast"]', () => this.hide()),
